...
@Controller
@RequestMapping("/staff-payments-list")
public class StaffPaymentController {
    ...
    public String addStaffPayment(@ModelAttribute StaffPayment staffPayment) {
        ...
        return "redirect:/staff-payments-list";  // Redirect to the list of staff payments
    }
